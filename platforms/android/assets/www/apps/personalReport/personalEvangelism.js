var personalEvangelismControl = angular.module('personalEvangelismScreen',[]);

personalEvangelismControl.controller('personalEvangelismController', personalEvangelismController);


function personalEvangelismController($scope, $http, $window) {
  ...
  $scope.endDate = "";
    ...
    $scope.getReport = function(){
      ...
      $http({
          ...
          url: 'https://flash-schedules.000webhostapp.com/personalEvangelism.php',
          timeout : 10000,
